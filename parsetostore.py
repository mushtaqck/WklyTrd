...
class ParseCustom():
    ...
    def parsemoneycontroldata(self,inptxt,indices,tm, r, symbllst):
        ...
        #symbol:h:price yymmddhh value
        #symbol:m:price yymmddhhmm value
...
if __name__ == '__main__':
    ...
    for index, item in enumerate(mclst):
        nsesymbl = r.get(item)
        mclst[index] = '{0}:{1}'.format(item,nsesymbl)
    print mclst
    ...
    #             t.parsemoneycontroldata(f.read(),'','m',r,mclst)
    ...
    #end_date = datetime.datetime.strptime('2014-11-30', '%Y-%m-%d')    
