...
#    quotes =  r.zrangebyscore('ONGC:m:price',201411220915,201412231530,withscores=True)
...
#    for a in quotes:
#        print a
#        d = datetime.datetime.strptime(repr(a[1]), "%Y%m%d%H%M.0") 
#        quotelst.append([float(a[0].replace(',','')),d])
...
#    plt.show()
    ...
    #    quotelst.append([float(p.replace(',','')),float(dt)])
